    ...
    <Layout>
      ...
      >
        ...
        <form
          ...
          className="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md" style={{ backgroundColor: "rgba(255, 255, 255, 0.9)" }}
        >
          <div className="mb-6">
          <textarea
            id="description"
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 text-sm font-medium text-white bg-black rounded-md shadow hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2"
          >
            {editStatus ? "Update Status" : "Create Status"}
          </button>
          <button
            onClick={goToWorkoutStatus}
            className="w-full px-4 mt-2 py-2 text-sm font-medium text-black bg-transparent rounded-md shadow hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
          >
            Cancel
          </button>
        </form>
...
export default FormWorkoutStatusPage;
