    ...
    <Layout>
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md" style={{ backgroundColor: "rgba(255, 255, 255, 0.9)" }}>
            ...
            <label
              ...
              <select
                name="mealType"
                className="border rounded h-sm w-full p-2 mt-2"
            ...
            <label
              ...
              <select
                ...
                className="border rounded h-sm w-full p-2 mt-4"
            ...
            <button
              type="submit"
              className="w-full mt-6 px-4 py-2 text-sm font-medium text-white bg-black rounded-md shadow hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
            >
            ...
            <button
              ...
              className="w-full px-4 mt-2 py-2 text-sm font-medium text-black bg-red-500 rounded-md shadow hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
            >
              Cancel
            </button>
          </div>
...
export default FormMealPlanePage;
