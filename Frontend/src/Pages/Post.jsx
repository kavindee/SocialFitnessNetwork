...
import backgroundImg from "../images/postbg.jpg";
...
const Post = () => {
  ...
  return (
    ...
    >
        ...
        <div className="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md " style={{ backgroundColor: "rgba(255, 255, 255, 0.9)" }}>
          <form
          ...
          >
            ...
            <button
              type="submit"
              className="flex w-full rounded  items-center justify-center  bg-black px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-orange-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] "
            >
