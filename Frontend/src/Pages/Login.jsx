...
import backgroundImg from "../images/bck55.jpg";
  ...
  return (
    <div className="bg-indigo-50 flex h-screen justify-center items-center" style={{
      ...
      backgroundAttachment: "fixed",
          ...
          <div className="w-full max-w-lg p-6 space-y-8 rounded-xl bg-white backdrop-blur-lg shadow-lg" style={{ backgroundColor: "rgba(64, 64, 64, 0.7)" }}>
              <form className = " ml-6 mr-6 mt-6 mb-6" onSubmit={handleSubmit(onSubmit)}>
          

              {/* Title and Subtitle */}
              <h1 className="text-2xl font-bold text-yellow-600 mb-4">Welcome</h1>
              <h2 className="text-lg text-white mb-6">Step into Your Fitness Adventure!</h2>
                <TEInput
                  type="email"
                  label="Email address"
                  size="lg"
